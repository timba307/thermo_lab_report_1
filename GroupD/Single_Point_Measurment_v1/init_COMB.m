function init_COMB(VRnum,samp,save_title)
...
COM_number_T = 'COM6';              %specifiy where the Thermometer is plugged in options: COM1, COM2, COM..
...
%ADV parameters
COM_number_A = 'COM2';                %specifiy where the ADV is plugged in options: COM1, COM2
...
%Grid parametrers
x_start =10;% 786.28;              %mm
y_start =-10;% -101.53;               %mm
z_start =-10;% -202.78;              %mm
...
go_TravEnd(s2,x_end/mmPst,y_end/mmPst,z_end/mmPst,3000);
