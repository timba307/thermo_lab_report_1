function set_erfi(vol)
    ...
    COM_number = 'COM8';                %specifiy where the erfi Power Supply is plugged in
    ...
    str = ['#01102' v a];       %check manual for more details about commands 3 digit is channel
